...

{
  ...
  users.users.demo = {
    ...
    description = "demo";
    shell = pkgs.zsh;
    extraGroups = [ "networkmanager" "wheel" "sudo" "docker" "vboxsf" "dialout" "plugdev" "adbusers"];
    packages = with pkgs; [
    #  firefox
    #  thunderbird
    ];
...
environment.systemPackages = with pkgs; [
  ...
  # To check whether the daemon is running: systemctl --user list-units ssh-agent.service --all
  # To check the logs: journalctl _SYSTEMD_UNIT=ssh-agent.service
