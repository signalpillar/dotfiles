...
| Question               | Answer                                                                                                                                                                                                                                        |
|------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| What is fact           | Bundle text that states what is true: `references/wiki/*.md` concepts with `type/title/status`, `references/glossary.yaml` terms, `_decision-*.md` rulings, `references/bigpicture.txt` AS-IS spine, toolbelt aid outputs, `_findings.md` evidence |
